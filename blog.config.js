...
const BLOG = {
  ...
  GREETING_WORDS:
    ...
    '感谢你的倾听，密码是你的手机号，6315那个',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'gengen', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '根根', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://guhui.net', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '树洞', // 网站关键词 英文逗号隔开
  ...
  MUSIC_PLAYER_METING_ID:
    process.env.NEXT_PUBLIC_MUSIC_PLAYER_METING_ID || '12848613712', // 对应歌单的 id
  ...
  // twikoo
  COMMENT_TWIKOO_ENV_ID: process.env.NEXT_PUBLIC_COMMENT_ENV_ID || true, // TWIKOO后端地址 腾讯云环境填envId；Vercel环境填域名，教程：https://tangly1024.com/article/notionnext-twikoo
